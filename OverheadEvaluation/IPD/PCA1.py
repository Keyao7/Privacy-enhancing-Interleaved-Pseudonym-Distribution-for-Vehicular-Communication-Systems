...
pca_key_dir = "/Users/keyaohuang/Desktop/Implementation/BaselineTwo/PCA1KeysSet/"
with open(os.path.join(pca_key_dir, "PCA1_private_key.pem"), "rb") as f:
    pca_private_key = serialization.load_pem_private_key(f.read(), password=None, backend=default_backend())

with open(os.path.join(pca_key_dir, "PCA1_public_key.pem"), "rb") as f:
